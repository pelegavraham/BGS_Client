...
#include "../include/ClientMessageFactory.h"

	byte[] ClientMessageFactory:: getMessageToSendServer(String input) 
	{
...
byte[] ClientMessageFactory:: shortToBytes(short num)
    {
...
short ClientMessageFactory::bytesToShort(byte[] byteArr)
    {
